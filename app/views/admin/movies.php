...
<form id="updateForm" action="/movies/1/edit" method="post">
    ...
    <input class="form-input" type="text" id="director" name="director" required>
...
<script>
    ...
    function fillForm(rowNumber) {
        ...
        updateForm.action = `/admin/movies/${rowId}/edit`;
    ...
    function deleteRow(rowId) {
        window.location.href = `/admin/movies/${rowId}/delete`;
    }
</script>