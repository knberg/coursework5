<div id="carouselExample" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="https://filmpoisk.com/wp-content/uploads/2023/07/multfilm-iz-instagrama-dlya-vsey-semi-2.jpg"
                class="d-block w-100" alt="Баннер 1">
            <div class="carousel-caption">
                <h5 class="banner-title">Мультфильм</h5>
                <button class="btn cinema-btn">Купить билет</button>
            </div>
        </div>
...
<div class="container mt-3">
    <h2 class="page-title">Мультфильмы</h2>
    <div class="row">
